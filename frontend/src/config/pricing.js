const WEDDING_ENGAGEMENT_SERVICES = [
  ...
  { name: 'Drone Coverage (Reception)', price: 7500, desc: 'Breathtaking aerial shots for reception.' },
  { name: 'Drone Coverage (Wedding)', price: 7500, desc: 'Breathtaking aerial shots for wedding.' },
