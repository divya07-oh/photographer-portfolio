  ...
  return (
    <>
      ...
      <div className="md:hidden flex items-center justify-between bg-dark text-cream p-4 sticky top-0 z-50">
        <div>
          <h1 className="font-serif text-lg leading-tight tracking-widest">MURALI RAGAVAN</h1>
      ...
      `}>
        <div className="p-8 hidden md:block">
          <h1 className="font-serif text-2xl leading-tight tracking-widest mb-1">MURALI RAGAVAN</h1>
